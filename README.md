## Backport of Upstream Pick Block Feature for Forge 1.20.1

This fork backports the **Pick Block** feature of AE2 storage terminals for Forge of Minecraft version 1.20.1. There are no new settings and it is constantly enabled. Default pick block keybind is Middle Click <video controls src="example.mp4" title="Example video"></video>

Most of the code for this backport was taken from the original upstream PR: [https://github.com/Mari023/AE2WirelessTerminalLibrary/pull/297](https://github.com/Mari023/AE2WirelessTerminalLibrary/pull/297)

### Important Notes:

- **Do not report issues** related to this backport to the original creators of Applied Energistics 2 or Applied Energistics 2 Wireless Terminal Library.
- If you encounter any issues, good luck. This backport won't be maintained.
